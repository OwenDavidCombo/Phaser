...
playGame.prototype = {
	// preloading images
     preload: function(){
          // image ship
          game.load.image("ship", "images/phaserexamples/ship (2).png");
          // horizontal barrier
          game.load.image("barrier", "images/phaserexamples/barrier.png");
          // vertical wall
          game.load.image("verticalbarrier", "images/phaserexamples/verticalbarrier.png");
	},
