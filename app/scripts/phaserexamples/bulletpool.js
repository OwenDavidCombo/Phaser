var game = new Phaser.Game(640, 400, Phaser.AUTO, 'game');
    ...
    PhaserGame.prototype = {
        ...
        preload: function () {
            ...
            this.load.image('background', 'images/phaserexamples/back.png');
            this.load.image('foreground', 'images/phaserexamples/fore.png');
            this.load.image('player', 'images/phaserexamples/ship.png');
            this.load.bitmapFont('shmupfont', 'images/phaserexamples/shmupfont.png', 'images/phaserexamples/shmupfont.xml');

            for (var i = 1; i <= 11; i++)
            {
                this.load.image('bullet' + i, 'images/phaserexamples/bullet' + i + '.png');
            }
