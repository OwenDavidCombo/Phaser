 var Shootout = {
    ...
    Shootout.Boot.prototype = {
        ...
        preload: function () {
            ...
            this.load.image('logo', 'images/photonstorm.png');
    ...
    Shootout.Preloader.prototype = {
        ...
        preload: function () {
            ...
            this.load.image('standoff', 'images/phaserexamples/standoff.png');
            this.load.image('win', 'images/phaserexamples/win.png');
            this.load.image('lose', 'images/phaserexamples/lose.png');
            this.load.image('draw', 'images/phaserexamples/draw.png');

            this.load.bitmapFont('font', 'images/phaserexamples/font.png', 'assets/font.xml');

            this.load.audio('casing', 'sounds/phaserexamples/casing.mp3');
            this.load.audio('fire', 'sounds/phaserexamples/fire.mp3');
            this.load.audio('reload', 'sounds/phaserexamples/reload.mp3');
            this.load.audio('splat', 'sounds/phaserexamples/splat.mp3');
            this.load.audio('walk', 'sounds/phaserexamples/walk.mp3');
