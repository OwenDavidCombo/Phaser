...
playGame.prototype = {
	preload: function(){
          game.load.image("road", "images/phaserexamples/road.png");
          game.load.image("car", "images/phaserexamples/car (2).png");
          game.load.image("obstacle", "images/phaserexamples/obstacle.png");
	},
  	create: function(){
