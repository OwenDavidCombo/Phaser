 var Shootout = {
    ...
    Shootout.Preloader.prototype = {
        ...
        preload: function () {
            ...
            this.load.image('standoff', 'images/standoff.png');
            this.load.image('win', 'images/win.png');
            this.load.image('lose', 'images/lose.png');
            this.load.image('draw', 'images/draw.png');

            this.load.bitmapFont('font', 'images/font.png', 'assets/font.xml');

            this.load.audio('casing', 'sounds/casing.mp3');
            this.load.audio('fire', 'sounds/fire.mp3');
            this.load.audio('reload', 'sounds/reload.mp3');
